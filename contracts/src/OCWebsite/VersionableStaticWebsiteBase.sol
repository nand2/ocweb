...
abstract contract VersionableStaticWebsiteBase is ResourceRequestWebsite, FrontendLibrary {
    ...
    function getLiveFrontendVersionIndex() public  view returns (uint256) {
